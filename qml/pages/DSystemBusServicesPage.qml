...
import harbour.dbus.inspector.DSystemBusServicesModel 1.0

/* Show the list of D-System-Bus services

   Uses the C++ DSystemBusNamesModel
 */
Page {
    id: page
